...
public class PantallaPausa implements Screen {
        ...
        //Estado Juego
        private mx.itesm.mission.EstadoJuego estado = mx.itesm.mission.EstadoJuego.PAUSADO;
        ...
        private mx.itesm.mission.Objeto sonido;
        ...
        private void crearObjetos() {
            ...
            btnResume.addListener(new ClickListener() {
                ...
                public void clicked(InputEvent event, float x, float y) {
                    ...
                    pantallaJuego.estado = mx.itesm.mission.EstadoJuego.JUGANDO;
            ...
            btnBm.addListener(new ClickListener() {
                ...
                public void clicked(InputEvent event, float x, float y) {
                    ...
                    //musicaFondo.stop();
                    mx.itesm.mission.Preferencias.guardarVidas(PantallaJuego.vida.getVida());
                    Gdx.app.log("Vida Guardada", mx.itesm.mission.Preferencias.cargarVida()+" ");
                    PantallaJuego.estadoNivel = EstadoNivel.PRIMERNIVEL;
                }

            });

            sonido = new mx.itesm.mission.Objeto(texturaBotonSonido,ANCHO/2+430,ALTO-600);
            sonido.sprite.setSize(64,64);
            if(mx.itesm.mission.Preferencias.cargarSonido()){
                musicaOn = true;
            }else{
                musicaOn = false;
            }
        ...
        private class tocar implements InputProcessor{
            ...
            public boolean touchDown(int screenX, int screenY, int pointer, int button) {
                ...
                if (sonido.contains(v)) {
                    mx.itesm.mission.Preferencias.guardarSonido(!mx.itesm.mission.Preferencias.cargarSonido());
                    cambiarTexturaSonido(mx.itesm.mission.Preferencias.cargarSonido());
                    return true;
                }
