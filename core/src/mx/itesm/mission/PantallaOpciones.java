...
public class PantallaOpciones implements Screen {
    ...
    //textos
    private mx.itesm.mission.Texto textoControles;
    private mx.itesm.mission.Texto textoItems;
    ...
    private void crearTexturas() {
        ...
        //Texto
        textoControles = new mx.itesm.mission.Texto("Fonts/fontLoading.fnt");
        textoItems = new mx.itesm.mission.Texto("Fonts/fontLoading.fnt");
    }
